...
Plugin URI: https://metinsaylan.com/wordpress/plugins/adsense-widget/
Description: Add Google Adsense ads using widget or shortcode. Supports up-to-date ad formats, responsive sizing and adsense placeholders!
Version: 2.1.1
Author: Metin Saylan
...
if( is_admin() ){
	...
	function plugin_add_settings_link( $links ) {
		...
		$links[] = '<a href="https://metinsaylan.com/live/donate/" target="_blank">' . __( 'Donate', 'adsense-widget' ) .  '</a>';
		return $links;
	}
